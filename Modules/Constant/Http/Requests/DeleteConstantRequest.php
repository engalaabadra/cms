...
/**
 * Class DeleteConstantRequest.
 */
class DeleteConstantRequest extends FormRequest
{
    /**
     * @var BaseRepository
    */
    protected $baseRepo;
    /**
     * DeleteConstantRequest constructor.
     *
     */
    ...
    public function authorize()
    {
      ...
      //delete Constant for only superadministrator  and admins
