...
/**
 * Class DeleteAudioCategoryRequest.
 */
class DeleteAudioRequest extends FormRequest
{
    /**
     * @var BaseRepository
    */
    protected $baseRepo;
    /**
     * DeleteAudioCategoryRequest constructor.
     *
     */
    ...
    public function authorize()
    {
      ...
      //delete AudioCategory for only superadministrator  and admins
