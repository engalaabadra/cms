...
namespace Modules\Article\Http\Requests\Categories;
...
class UpdateArticleRequest extends FormRequest
{
    ...
    */
    ...
    {
            return [
                'title' => ['max:225','required',Rule::unique('article_categories')->ignore($this->id)],
                'slug' => ['max:225','required',Rule::unique('article_categories')->ignore($this->id)],
